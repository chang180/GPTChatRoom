...
> **Sync:** Mirror for [`.claude/CLAUDE.md`](../.claude/CLAUDE.md). Canonical rules: [`.cursor/rules/laravel-boost.mdc`](rules/laravel-boost.mdc). Index: [`AGENTS.md`](../AGENTS.md).
...
- **Build Tool**: Vite 7, `@inertiajs/vite` 3
