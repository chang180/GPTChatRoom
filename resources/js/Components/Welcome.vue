...
<template>
    ...
    <div class="p-6 bg-white border-b border-gray-200 lg:p-8">
        ...
        <p class="mt-6 leading-relaxed text-center text-gray-500">
            This is the main dashboard where you can manage your application. Use the navigation links to access different sections of the application.
        </p>
    </div>
    ...
    <div class="grid grid-cols-1 gap-6 p-6 bg-gray-200 bg-opacity-25 md:grid-cols-2 lg:gap-8 lg:p-8">
        <div>
            ...
            <p class="mt-4 text-sm leading-relaxed text-gray-500">
                Check out the documentation to get detailed information on how to use and customize the application.
            </p>
        ...
        <div>
            ...
            <p class="mt-4 text-sm leading-relaxed text-gray-500">
                Access a variety of tutorials to enhance your understanding and skills in using this application.
            </p>
