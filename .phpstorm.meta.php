    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            ...
            'Illuminate\Contracts\Broadcasting\Broadcaster' => \Ably\LaravelBroadcaster\AblyBroadcaster::class,
    ...
    override(\config(), map([
            ...
            'cache.prefix' => 'string',
            'conversation.context_limit' => 'integer',
            'conversation.summarize_min_overflow' => 'integer',
            'conversation.summarize_max_tokens' => 'integer',
            'conversation.summary_compress_max_tokens' => 'integer',
            'conversation.summary_max_chars' => 'integer',
            'conversation.summary_context_max_chars' => 'integer',
            ...
            'filesystems.links./Users/changchien-wen/Herd/GPTChatRoom/public/storage' => 'string',
            ...
            'services.google.enabled' => 'boolean',
            'services.google.disabled_reason' => 'string',
...
'broadcasting.connections.ably.token_expiry','broadcasting.connections.log.driver','broadcasting.connections.null.driver','broadcasting.client_enabled','cache.default',
...
'cache.stores.octane.driver','cache.stores.failover.driver','cache.stores.failover.stores','cache.prefix','conversation.context_limit',
'conversation.summarize_min_overflow','conversation.summarize_max_tokens','conversation.summary_compress_max_tokens','conversation.summary_max_chars','conversation.summary_context_max_chars',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.links./Users/changchien-wen/Herd/GPTChatRoom/public/storage','fortify.guard',
...
'fortify.features','inertia.ssr.enabled','inertia.ssr.runtime','inertia.ssr.ensure_runtime_exists','inertia.ssr.url',
...
'inertia.devtools.gate','inertia.devtools.redact.keys','inertia.devtools.redact.headers','jetstream.stack','jetstream.middleware',
...
'logging.channels.nightwatch.level','mail.default','mail.mailers.smtp.transport','mail.mailers.smtp.url','mail.mailers.smtp.host',
...
'mail.from.name','mail.markdown.theme','mail.markdown.paths','mail.markdown.extensions','openai.api_key',
'openai.organization','openai.model','openai.request_timeout','queue.default','queue.connections.sync.driver',
...
'services.ses.region','services.slack.notifications.bot_user_oauth_token','services.slack.notifications.channel','services.openai.api_key','services.google.client_id',
'services.google.client_secret','services.google.redirect','services.google.enabled','services.google.disabled_reason','session.driver',
...
'mcp.tool_search.max_output_bytes','nightwatch.enabled','nightwatch.token','nightwatch.deployment','nightwatch.server',
...
'nightwatch.ingest.timeout','nightwatch.ingest.connection_timeout','nightwatch.ingest.event_buffer','flare.key','flare.flare_middleware',
...
'ignition.updateConfig','home','auth.google.redirect',
'auth.google.callback','chat.invitations.accept','user.google.link','user.google.unlink','dashboard',
'admin.dashboard','admin.users.update','chat.index','chat.load-more','chat.send-message',
'chat.send-message-stream','chat.clear','chat.private.index','chat.private.store','chat.private.show',
'chat.private.destroy','chat.private.invitations.store','chat.private.members.destroy','chat.theme',);
        registerArgumentsSet('views', 
'app','components.dark-mode-toggle','emails.team-invitation','laravel-exceptions::401','laravel-exceptions::402',
...
'VITE_APP_NAME','VITE_ABLY_ENABLED','ABLY_KEY','ABLY_TOKEN_EXPIRY','OPENAI_ORGANIZATION',
